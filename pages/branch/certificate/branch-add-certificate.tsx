...
const VehicleBranchByPlateNumber = gql`
  query VehicleBranchByPlateNumber($plateNumber: String!, $branchId: String!) {
    vehicleBranchByPlateNumber(plateNumber: $plateNumber, branchId: $branchId) {
      id
      plateNumber
      engineNumber
      chassisNumber
    ...
    <>
      ...
      <div className="max-w-[90%] mx-auto px-4 sm:px-6 lg:px-8 py-4 bg-white mt-20 rounded-3xl">
        <div className="space-y-8 divide-y divide-gray-200 sm:space-y-5">
          ...
          <div className="px-10 ml-10">
            {vehicleBranchByPlateNumberData?.vehicleBranchByPlateNumber ===
              null && (
              <p className="mt-2 max-w-2xl text-lg font-medium text-eRed">
                          ...
                          <tr
                            key={
                              vehicleBranchByPlateNumberData
                                ?.vehicleBranchByPlateNumber?.id
                            }
                          >
                            <td className="whitespace-normal py-4 pl-4 pr-4 text-sm text-gray-500 sm:pr-6">
                              {
                                vehicleBranchByPlateNumberData
                                  ?.vehicleBranchByPlateNumber?.plateNumber
                              }
                            </td>
                            <td className="whitespace-nowrap py-4 pl-4 pr-4 text-sm text-gray-500 sm:pr-6">
                              {
                                vehicleBranchByPlateNumberData
                                  ?.vehicleBranchByPlateNumber?.engineNumber
                              }
                            </td>
                            <td className="whitespace-nowrap py-4 pl-4 pr-4 text-sm text-gray-500 sm:pr-6">
                              {
                                vehicleBranchByPlateNumberData
                                  ?.vehicleBranchByPlateNumber?.chassisNumber
                              }
                            </td>
                            <td className="whitespace-nowrap py-4 pl-4 pr-4 text-sm text-gray-500 sm:pr-6">
                              {
                                vehicleBranchByPlateNumberData
                                  ?.vehicleBranchByPlateNumber?.vehicleType
                              }
                            </td>
                            <td className="whitespace-normal py-4 pl-4 pr-4 text-sm text-gray-500 sm:pr-6">
                              {
                                vehicleBranchByPlateNumberData
                                  ?.vehicleBranchByPlateNumber?.vehicleSubType
                              }
                            </td>
                            <td className="whitespace-normal py-4 pl-4 pr-4 text-sm text-gray-500 sm:pr-6">
                              {
                                vehicleBranchByPlateNumberData
                                  ?.vehicleBranchByPlateNumber?.vehicleDetails
                              }
                            </td>
                            <td className="whitespace-normal text-ellipsis overflow-hidden ... py-4 pl-4 pr-4 text-sm text-gray-500 sm:pr-6">
                              {
                                vehicleBranchByPlateNumberData
                                  ?.vehicleBranchByPlateNumber?.vehicleUsage
                              }
                            </td>
                            <td className="whitespace-normal py-4 pl-4 pr-4 text-sm text-gray-500 sm:pr-6">
                              {
                                vehicleBranchByPlateNumberData
                                  ?.vehicleBranchByPlateNumber?.vehicleCategory
                              }
                            </td>
                            <td className="whitespace-normal py-4 pl-4 pr-4 text-sm text-gray-500 sm:pr-6">
                              {
                                vehicleBranchByPlateNumberData
                                  ?.vehicleBranchByPlateNumber?.passengerNumber
                              }
                            </td>
                            <td className="whitespace-nowrap py-4 pl-4 pr-4 text-sm text-gray-500 sm:pr-6">
                              {
                                vehicleBranchByPlateNumberData
                                  ?.vehicleBranchByPlateNumber?.premiumTarif
                              }
                            </td>
                            <td className="whitespace-normal py-4 pl-4 pr-4 text-sm text-gray-500 sm:pr-6">
                              {
                                vehicleBranchByPlateNumberData
                                  ?.vehicleBranchByPlateNumber?.isInsured
                              }
                            </td>
...
export default BranchAddCertificate;
