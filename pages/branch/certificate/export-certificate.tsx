...
const ExportCertificateBranch = gql`
  query ExportCertificateBranch(
    $branchId: String!
    $dateFrom: String!
    $dateTo: String!
  ) {
    exportCertificateBranch(
      branchId: $branchId
      dateFrom: $dateFrom
      dateTo: $dateTo
    ) {
...
const ExportBranchCertificate = ({
  ...
  const [
    exportData,
    {
      loading: exportCertificateBranchLoading,
      error: exportCertificateBranchError,
      data: exportCertificateBranchData,
    },
  ] = useLazyQuery(ExportCertificateBranch);

  if (exportCertificateBranchData) {
    slicedValue = exportCertificateBranchData?.exportCertificateBranch?.slice(
      0,
      size
    );
  }
        ...
        <div className="px-4 sm:px-6 lg:px-8">
          ...
          <div className="-my-2 -mx-4 overflow-x-auto sm:-mx-6 lg:-mx-8">
            <div className="text-gray-900 body-font overflow-hidden bg-white border-2 rounded-3xl border-gray-200 mt-5">
                    ...
                    <div className="mt-2 mb-5 flex flex-col">
                      <div className="sm:col-span-2 sm:flex sm:justify-center mt-2">
                        <h3 className="text-eRed font-bold text-lg">
                          {exportCertificateBranchError.message}
                        </h3>
                      </div>
                    </div>
                  </div>
              ...
              <div className="px-10 ml-10">
                {exportCertificateBranchData?.exportCertificateBranch?.length <=
                  0 && (
                  <div className="px-1 sm:px-2 lg:px-4">
                    <div className="mt-2 mb-5 flex flex-col">
                      <div className="sm:col-span-2 sm:flex sm:justify-center mt-2">
                ...
                <>
                  <div className="pt-1">
                    <div className="flex justify-center pt-1">
                      <CertificateExport
                        certificates={
                          exportCertificateBranchData?.exportCertificateBranch
                        }
                      />
                    </div>
                  </div>
...
export default ExportBranchCertificate;
