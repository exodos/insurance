...
const ExportVehicleByBranch = gql`
  query ExportVehicleByBranch(
    $branchId: String!
    $dateFrom: String!
    $dateTo: String!
  ) {
    exportVehicleByBranch(
      branchId: $branchId
      dateFrom: $dateFrom
      dateTo: $dateTo
    ) {
...
const ExportBranchVehicle = ({
  ...
  const [
    exportData,
    {
      loading: exportVehicleByBranchLoading,
      error: exportVehicleByBranchError,
      data: exportVehicleByBranchData,
    },
  ] = useLazyQuery(ExportVehicleByBranch);

  if (exportVehicleByBranchData) {
    slicedValue = exportVehicleByBranchData?.exportVehicleByBranch?.slice(
      0,
      size
    );
  }
        ...
        <div className="px-4 sm:px-6 lg:px-8">
          ...
          <div className="-my-2 -mx-4 overflow-x-auto sm:-mx-6 lg:-mx-8">
            <div className="text-gray-900 body-font overflow-hidden bg-white border-2 rounded-3xl border-gray-200 mt-5">
                    ...
                    <div className="mt-2 mb-5 flex flex-col">
                      <div className="sm:col-span-2 sm:flex sm:justify-center mt-2">
                        <h3 className="text-eRed font-bold text-lg">
                          {exportVehicleByBranchError.message}
                        </h3>
                      </div>
                    </div>
                  </div>
              ...
              <div className="px-10 ml-10">
                {exportVehicleByBranchData?.exportVehicleByBranch?.length <=
                  0 && (
                  <div className="px-1 sm:px-2 lg:px-4">
                    <div className="mt-2 mb-5 flex flex-col">
                      <div className="sm:col-span-2 sm:flex sm:justify-center mt-2">
              ...
              {exportVehicleByBranchData?.exportVehicleByBranch?.length > 0 && (
                <>
                  <div className="pt-1">
                    <div className="flex justify-center pt-1">
                      <VehicleExport
                        vehicles={
                          exportVehicleByBranchData?.exportVehicleByBranch
                        }
                      />
                    </div>
                  </div>
...
export default ExportBranchVehicle;
