...
const ExportAdminPayment = gql`
  query ExportAdminPayment(
    $dateFrom: String!
    $dateTo: String!
...
const AdminExportPayment = ({
  ...
  const [
    exportData,
    {
      loading: exportAdminPaymentLoading,
      error: exportAdminPaymentError,
      data: exportAdminPaymentData,
    },
  ] = useLazyQuery(ExportAdminPayment);

  if (exportAdminPaymentData) {
    slicedValue = exportAdminPaymentData?.exportAdminPayment?.slice(0, size);
  }
  return (
    <>
      <SiteHeader
        ...
        <div className="px-4 sm:px-6 lg:px-8">
          ...
          <div className="-my-2 -mx-4 overflow-x-auto sm:-mx-6 lg:-mx-8">
            <div className="text-gray-900 body-font overflow-hidden bg-white border-2 rounded-3xl border-gray-200 mt-5">
                    ...
                    <div className="mt-2 mb-5 flex flex-col">
                      <div className="sm:col-span-2 sm:flex sm:justify-center mt-2">
                        <h3 className="text-eRed font-bold text-lg">
                          {exportAdminPaymentError.message}
                        </h3>
                      </div>
                    </div>
                  </div>
              ...
              <div className="px-10 ml-10">
                {exportAdminPaymentData?.exportAdminPayment?.length <= 0 && (
                  <div className="px-1 sm:px-2 lg:px-4">
                    <div className="mt-2 mb-5 flex flex-col">
                      <div className="sm:col-span-2 sm:flex sm:justify-center mt-2">
                        <h3 className="text-eRed font-bold text-lg">
                ...
                <>
                  <div className="pt-1">
                    <div className="flex justify-center pt-1">
                      <PaymentsExport
                        payments={exportAdminPaymentData.exportAdminPayment}
                      />
                    </div>
                  </div>
                  <div className="px-1 sm:px-2 lg:px-4">
