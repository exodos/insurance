...
const ExportInsured = gql`
  query ExportInsured($dateFrom: String!, $dateTo: String!) {
    exportInsured(dateFrom: $dateFrom, dateTo: $dateTo) {
      id
      regNumber
      firstName
      lastName
...
const ExportAdminInsured = ({
  ...
  const [
    exportData,
    {
      loading: exportInsuredLoading,
      error: exportInsuredError,
      data: exportInsuredData,
    },
  ] = useLazyQuery(ExportInsured);

  if (exportInsuredData) {
    slicedValue = exportInsuredData?.exportInsured?.slice(0, size);
  }
  return (
    <>
      <SiteHeader
        ...
        <div className="px-4 sm:px-6 lg:px-8">
          ...
          <div className="-my-2 -mx-4 overflow-x-auto sm:-mx-6 lg:-mx-8">
            <div className="text-gray-900 body-font overflow-hidden bg-white border-2 rounded-3xl border-gray-200 mt-5">
              ...
              <div className="px-10 ml-10">
                {exportInsuredData?.exportInsured?.length <= 0 && (
                  <div className="px-1 sm:px-2 lg:px-4">
                    <div className="mt-2 mb-5 flex flex-col">
                      <div className="sm:col-span-2 sm:flex sm:justify-center mt-2">
                        <h3 className="text-eRed font-bold text-lg">
                ...
                <>
                  <div className="pt-1">
                    <div className="flex justify-center pt-1">
                      <InsuredExport
                        insureds={exportInsuredData?.exportInsured}
                      />
                    </div>
                  </div>
                  <div className="px-1 sm:px-2 lg:px-4">
...
export default ExportAdminInsured;
