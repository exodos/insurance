...
const ExportUnInsuredPoliceReport = gql`
  query ExportUnInsuredPoliceReport($dateFrom: String!, $dateTo: String!) {
    exportUnInsuredPoliceReport(dateFrom: $dateFrom, dateTo: $dateTo) {
      id
      incidentNumber
      victimDriverName
      victimLicenceNumber
...
const ExportAdminUnInsuredPoliceReport = ({
  ...
  const [
    exportData,
    {
      loading: exportUNInsuredPoliceReportQueryLoading,
      error: exportUnInsuredPoliceReportQueryError,
      data: exportUnInsuredPoliceReportQueryData,
    },
  ] = useLazyQuery(ExportUnInsuredPoliceReport);

  if (exportUnInsuredPoliceReportQueryData) {
    slicedValue =
      exportUnInsuredPoliceReportQueryData?.exportUnInsuredPoliceReport?.slice(
        0,
        size
      );
  }
  return (
    <>
      <SiteHeader
        title={"Third Party Insurance Export Police Report Page"}
        content={"Third Party Insurance Export Police Report Page"}
      />
          ...
          <div className="-my-2 -mx-4 overflow-x-auto sm:-mx-6 lg:-mx-8">
            <div className="text-gray-900 body-font overflow-hidden bg-white border-2 rounded-3xl border-gray-200 mt-5">
              ...
              <div className="px-10 ml-10">
                {exportUnInsuredPoliceReportQueryError && (
                    ...
                    <div className="mt-2 mb-5 flex flex-col">
                      <div className="sm:col-span-2 sm:flex sm:justify-center mt-2">
                        <h3 className="text-eRed font-bold text-lg">
                          {exportUnInsuredPoliceReportQueryError.message}
                        </h3>
                      </div>
                    </div>
                  </div>
              ...
              <div className="px-10 ml-10">
                {exportUnInsuredPoliceReportQueryData
                  ?.exportUnInsuredPoliceReport?.length <= 0 && (
                  <div className="px-1 sm:px-2 lg:px-4">
                    <div className="mt-2 mb-5 flex flex-col">
                      <div className="sm:col-span-2 sm:flex sm:justify-center mt-2">
                        <h3 className="text-eRed font-bold text-lg">
              ...
              {exportUnInsuredPoliceReportQueryData?.exportUnInsuredPoliceReport
                ?.length > 0 && (
                <>
                  <div className="pt-1">
                    <div className="flex justify-center pt-1">
                      <UnInsuredPoliceReportExport
                        policeReports={
                          exportUnInsuredPoliceReportQueryData.exportUnInsuredPoliceReport
                        }
                      />
                              ...
                              {slicedValue.length > 0 &&
                                slicedValue.map((item: any, i: any) => (
                                  <tr key={item?.id}>
                                    ...
                                    <td className="whitespace-nowrap py-4 pl-4 pr-4 text-sm text-gray-500 sm:pr-6">
                                      {item?.claimUnInsureds?.claimNumber}
                                    </td>
                                    <td className="whitespace-nowrap py-4 pl-4 pr-4 text-sm text-gray-500 sm:pr-6">
                                      {format(
...
export default ExportAdminUnInsuredPoliceReport;
