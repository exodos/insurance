...
const ExportInsuredPoliceReportQuery = gql`
  query ExportInsuredPoliceReport($dateFrom: String!, $dateTo: String!) {
    exportInsuredPoliceReport(dateFrom: $dateFrom, dateTo: $dateTo) {
      id
      incidentNumber
      victimDriverName
      victimLicenceNumber
...
const ExportAdminPoliceReport = ({
  ...
  const [
    exportData,
    {
      loading: exportInsuredPoliceReportQueryLoading,
      error: exportInsuredPoliceReportQueryError,
      data: exportInsuredPoliceReportQueryData,
    },
  ] = useLazyQuery(ExportInsuredPoliceReportQuery);

  if (exportInsuredPoliceReportQueryData) {
    slicedValue =
      exportInsuredPoliceReportQueryData?.exportInsuredPoliceReport?.slice(
        0,
        size
      );
  }
          ...
          <div className="-my-2 -mx-4 overflow-x-auto sm:-mx-6 lg:-mx-8">
            <div className="text-gray-900 body-font overflow-hidden bg-white border-2 rounded-3xl border-gray-200 mt-5">
              ...
              <div className="px-10 ml-10">
                {exportInsuredPoliceReportQueryError && (
                    ...
                    <div className="mt-2 mb-5 flex flex-col">
                      <div className="sm:col-span-2 sm:flex sm:justify-center mt-2">
                        <h3 className="text-eRed font-bold text-lg">
                          {exportInsuredPoliceReportQueryError.message}
                        </h3>
                      </div>
                    </div>
                  </div>
              ...
              <div className="px-10 ml-10">
                {exportInsuredPoliceReportQueryData?.exportInsuredPoliceReport
                  ?.length <= 0 && (
                  <div className="px-1 sm:px-2 lg:px-4">
                    <div className="mt-2 mb-5 flex flex-col">
                      <div className="sm:col-span-2 sm:flex sm:justify-center mt-2">
                            ...
                            <thead className="bg-gray-50">
                              <tr>
                                ...
                                <th
                                  ...
                                  className="py-3.5 pl-4 pr-3 text-left text-sm font-semibold text-gray-900 sm:pl-6"
                                >
                                  Responsible Vehicle Plate Number
                                </th>
...
export default ExportAdminPoliceReport;
