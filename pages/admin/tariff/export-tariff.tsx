...
import TariffExport from "@/components/tariff/tariff-export";

const ExportTariff = gql`
  query ExportTariff($dateFrom: String!, $dateTo: String!) {
    exportTariff(dateFrom: $dateFrom, dateTo: $dateTo) {
      vehicleType
      vehicleSubType
      vehicleDetail
      vehicleUsage
...
const ExportAdminTariff = ({
  ...
  const [
    exportData,
    {
      loading: exportTariffLoading,
      error: exportTariffError,
      data: exportTariffData,
    },
  ] = useLazyQuery(ExportTariff);

  if (exportTariffData) {
    slicedValue = exportTariffData?.exportTariff?.slice(0, size);
  }
  return (
    <>
      <SiteHeader
        title={"Third Party Insurance Export Tariff Page"}
        content={"Third Party Insurance Export Tariff Page"}
      />
        ...
        <div className="px-4 sm:px-6 lg:px-8">
          ...
          <div className="-my-2 -mx-4 overflow-x-auto sm:-mx-6 lg:-mx-8">
            <div className="text-gray-900 body-font overflow-hidden bg-white border-2 rounded-3xl border-gray-200 mt-5">
              ...
              <div className="px-10 ml-10">
                {exportTariffData?.exportTariff?.length <= 0 && (
                  <div className="px-1 sm:px-2 lg:px-4">
                    <div className="mt-2 mb-5 flex flex-col">
                      <div className="sm:col-span-2 sm:flex sm:justify-center mt-2">
                        <h3 className="text-eRed font-bold text-lg">
                ...
                <>
                  <div className="pt-1">
                    <div className="flex justify-center pt-1">
                      <TariffExport tariffs={exportTariffData?.exportTariff} />
                    </div>
                  </div>
                  <div className="px-1 sm:px-2 lg:px-4">
...
export default ExportAdminTariff;
