...
const AdminSuspendedVehiclePage = ({
      data,
  ...
  return (
    <>
      <SiteHeader
        title={"Third Party Insurance Suspende Vehicle Page"}
        content={"Third Party Insurance Suspende Vehicle Page"}
      />
...
export default AdminSuspendedVehiclePage;
