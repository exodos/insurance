...
const AdminPendingPaymentPage = ({
  ...
  return (
    <>
      <SiteHeader
        title={"Third Party Insurance Pending Payment Page"}
        content={"Third Party Insurance Pending Payment Page"}
      />
                ...
                {session.user.memberships.role === "SUPERADMIN" && (
                  ...
                  >
                    <>
                      ...
                      <ReactTooltip
                        id="exportPendingPayment"
                        place="top"
                        effect="solid"
                      >
                        Export Pending Payment
                      </ReactTooltip>
                    </>
                  </Link>
                )}
...
export default AdminPendingPaymentPage;
