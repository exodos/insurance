...
const FeedClaimUnInsuredByPoliceBranch = gql`
  query FeedClaimUnInsuredByPoliceBranch(
    $branchId: String!
    $filter: String
    $skip: Int
    $take: Int
    ...
    feedClaimUnInsuredByPoliceBranch(
      branchId: $branchId
      filter: $filter
      skip: $skip
      take: $take
...
const PoliceUserClaimUnInsured = ({
      data,
  ...
  return (
    <>
      ...
      <div className="max-w-full mx-auto px-4 sm:px-6 lg:px-8 py-4">
        ...
        <ListUnInsuredClaim
          claimData={data.feedClaimUnInsuredByPoliceBranch}
          href={asPath}
        />
      </div>
    </>
...
export default PoliceUserClaimUnInsured;
