...
const PoliceListUser = ({ userData, roleList, href }) => {
  ...
  return (
    <>
      ...
      {showEditModal ? (
        <EditUserModal user={editList} roleList={roleList} href={href} />
      ) : null}
      {showDeleteModal ? (
        <DeleteUserModal user={deleteList} href={href} />
      ) : null}
      {showRestModal ? (
        <AdminResetPassword user={resetList} href={href} />
      ) : null}
    </>
  );
};

export default PoliceListUser;
