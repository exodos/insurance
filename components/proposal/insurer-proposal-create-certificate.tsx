...
import {
  InsurerFormContext,
  InsurerVehicleInfoContext,
} from "@/pages/insurer/certificate/insurer-proposal-create-insurance";

const InsurerProposalCreateCertificate = () => {
  const { activeStepIndex, setActiveStepIndex, formData, setFormData } =
    useContext(InsurerFormContext);

  const { branchOptions } = useContext(InsurerVehicleInfoContext);
...
export default InsurerProposalCreateCertificate;
