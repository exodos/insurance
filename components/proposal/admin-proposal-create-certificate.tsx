...
import {
  AdminFormContext,
  AdminVehicleInfoContext,
} from "@/pages/admin/certificate/admin-proposal-create-insurance";

const AdminProposalCreateCertificate = () => {
  const { activeStepIndex, setActiveStepIndex, formData, setFormData } =
    useContext(AdminFormContext);

  const { branchOptions } = useContext(AdminVehicleInfoContext);
...
export default AdminProposalCreateCertificate;
