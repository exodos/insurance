...
const UpdateBranch = gql`
  mutation UpdateBranch($updateBranchId: String!, $input: branchUpdateInput!) {
...
const EditBranchModal = ({ branchs, href }) => {
  const notificationCtx = useContext(NotificationContext);
  const [open, setOpen] = useState<boolean>(true);

  const [updateBranch, { data, error, loading }] = useMutation(UpdateBranch);
