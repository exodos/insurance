...
const AdminOrganizationsDelete = ({ organizations }) => {
  ...
  const deleteIneligible = async () => {
    ...
    await deleteOrganization({
      ...
      onCompleted: (data) => {
        notificationCtx.showNotification({
          title: "Success!",
          message: data.message || "Successfully Deleted Insurer",
          status: "success",
        });
      },
      update: (cache, { data }) => {
                ...
                <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                  ...
                  <div className="mt-2">
                    <p className="text-sm text-gray-500">
                      Are you sure you want to delete this insurer? All of data
...
export default AdminOrganizationsDelete;
