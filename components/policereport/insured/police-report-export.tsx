...
const PoliceReportExport = ({ policeReports }) => {
  const [policeReportsHeaders] = useState([
    ...
    { label: "Victim Driver PhoneNumber", key: "victimPhoneNumber" },
    {
      ...
      key: "vehicle_PoliceReport_victimVehicle.plateNumber",
    },
    ...
    { label: "Responsible Driver PhoneNumber", key: "responsiblePhoneNumber" },
    {
      ...
      key: "vehicle_PoliceReport_responsibleVehicle.plateNumber",
    },
    ...
    { label: "Claim Number", key: "claims.claimNumber" },
  ...
  const data = policeReports.map((item: any) => ({
    ...
    vehicle_PoliceReport_victimVehicle: {
      plateNumber: item?.vehicle_PoliceReport_victimVehicle?.plateNumber,
    },
    ...
    vehicle_PoliceReport_responsibleVehicle: {
      plateNumber: item?.vehicle_PoliceReport_responsibleVehicle?.plateNumber,
    },
    branchs: {
    ...
    claims: {
      claimNumber: item?.claims?.claimNumber,
    },
...
export default PoliceReportExport;
