...
const DetailUnInsuredReport = ({ policeReport }) => {
                            ...
                            <div className="bg-white px-4 py-5 grid-cols-4 grid gap-4">
                              ...
                              <div className="grid-cols-1 sm:grid-cols-1 sm:mt-0">
                                ...
                                <dd className="text-sm text-gray-900">
                                  ...
                                  &nbsp;&nbsp;
                                  {policeReport?.trafficPolices.lastName}
                                </dd>
                              </div>
                              <div className="grid-cols-1 sm:grid-cols-1 sm:mt-0">
                                <dt className="text-sm font-medium text-gray-500">
                          ...
                          <dl>
                            <div className="bg-white px-4 py-5 grid-cols-4 grid gap-4">
                              ...
                              <div className="grid-cols-1 sm:grid-cols-1 sm:mt-0">
                                ...
                                <dd className="text-sm text-gray-900">
                                  {policeReport?.victimVehiclePlateNumber}
                                </dd>
                              </div>
                              <div className="grid-cols-1 sm:grid-cols-1 sm:mt-0">
                                <dt className="text-sm font-medium text-gray-500">
                                ...
                                <dd className="text-sm text-gray-900">
                                  {policeReport?.responsibleVehiclePlateNumber}
                                </dd>
                              </div>
                            </div>
                          </dl>
...
export default DetailUnInsuredReport;
