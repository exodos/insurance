...
const FeedVehicleByInsuredReg = gql`
  query FeedVehicleByInsuredReg($regNumber: String!, $orgId: String!) {
    feedVehicleByInsuredReg(regNumber: $regNumber, orgId: $orgId) {
      vehicles {
        id
        plateNumber
        engineNumber
...
const InsurerVehicleByRegNumber = ({ orgId, branchId, path }) => {
...
export default InsurerVehicleByRegNumber;
