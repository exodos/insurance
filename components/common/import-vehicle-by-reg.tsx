...
const InsuredBranchByRegNumber = gql`
  query InsuredBranchByRegNumber($regNumber: String!, $branchId: String!) {
    insuredBranchByRegNumber(regNumber: $regNumber, branchId: $branchId) {
      id
      regNumber
      firstName
      lastName
...
const ImportVehicleByRegNumber = ({ branchId, path }) => {
  ...
  const [
    vehicleData,
    {
      loading: insuredBranchByRegNumberLoading,
      error: insuredBranchByRegNumberError,
      data: insuredBranchByRegNumberData,
    },
  ] = useLazyQuery(InsuredBranchByRegNumber);
      ...
      <div className="max-w-[90%] mx-auto px-4 sm:px-6 lg:px-8 py-4 bg-white mt-20 rounded-3xl">
        <div className="space-y-8 sm:space-y-5">
          ...
          <div className="px-10 ml-10">
            {insuredBranchByRegNumberError && (
              <p className="mt-2 max-w-2xl text-lg font-medium text-eRed">
                {insuredBranchByRegNumberError.message}
              </p>
            )}
          </div>
          <div className="px-10 ml-10">
            {insuredBranchByRegNumberData?.insuredBranchByRegNumber ===
              null && (
              <p className="mt-2 max-w-2xl text-lg font-medium text-eRed">
                    ...
                    <div className="overflow-hidden shadow ring-1 ring-black ring-opacity-5 md:rounded-lg">
                      <table className="min-w-full divide-y divide-gray-300">
                        ...
                        <tbody className="divide-y divide-gray-200 bg-white">
                          <tr
                            key={
                              insuredBranchByRegNumberData
                                ?.insuredBranchByRegNumber?.id
                            }
                          >
                            <td className="whitespace-nowrap py-4 pl-4 pr-4 text-sm text-gray-500 sm:pr-6">
                              {
                                insuredBranchByRegNumberData
                                  ?.insuredBranchByRegNumber?.regNumber
                              }
                            </td>
                            <td className="whitespace-nowrap py-4 pl-4 pr-4 text-sm text-gray-500 sm:pr-6">
                              {
                                insuredBranchByRegNumberData
                                  ?.insuredBranchByRegNumber?.firstName
                              }
                            </td>
                            <td className="whitespace-nowrap py-4 pl-4 pr-4 text-sm text-gray-500 sm:pr-6">
                              {
                                insuredBranchByRegNumberData
                                  ?.insuredBranchByRegNumber?.lastName
                              }
                            </td>
                            <td className="whitespace-nowrap py-4 pl-4 pr-4 text-sm text-gray-500 sm:pr-6">
                              {
                                insuredBranchByRegNumberData
                                  ?.insuredBranchByRegNumber?.occupation
                              }
                            </td>
                            <td className="whitespace-nowrap py-4 pl-4 pr-4 text-sm text-gray-500 sm:pr-6">
                              {
                                insuredBranchByRegNumberData
                                  ?.insuredBranchByRegNumber?.region
                              }
                            </td>
                            <td className="whitespace-nowrap py-4 pl-4 pr-4 text-sm text-gray-500 sm:pr-6">
                              {
                                insuredBranchByRegNumberData
                                  ?.insuredBranchByRegNumber?.city
                              }
                            </td>
                            <td className="whitespace-nowrap py-4 pl-4 pr-4 text-sm text-gray-500 sm:pr-6">
                              {
                                insuredBranchByRegNumberData
                                  ?.insuredBranchByRegNumber?.subCity
                              }
                            </td>
                            <td className="whitespace-nowrap py-4 pl-4 pr-4 text-sm text-gray-500 sm:pr-6">
                              {
                                insuredBranchByRegNumberData
                                  ?.insuredBranchByRegNumber?.wereda
                              }
                            </td>
                            <td className="whitespace-nowrap py-4 pl-4 pr-4 text-sm text-gray-500 sm:pr-6">
                              {
                                insuredBranchByRegNumberData
                                  ?.insuredBranchByRegNumber?.kebelle
                              }
                            </td>
                            <td className="whitespace-nowrap py-4 pl-4 pr-4 text-sm text-gray-500 sm:pr-6">
                              {
                                insuredBranchByRegNumberData
                                  ?.insuredBranchByRegNumber?.houseNumber
                              }
                            </td>
                            <td className="whitespace-normal py-4 pl-4 pr-4 text-sm text-gray-500 sm:pr-6">
                              {
                                insuredBranchByRegNumberData
                                  ?.insuredBranchByRegNumber?.mobileNumber
                              }
                            </td>
...
export default ImportVehicleByRegNumber;
