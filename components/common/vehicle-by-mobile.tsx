...
const FeedVehicleByInsured = gql`
  query FeedVehicleByInsured($mobileNumber: String!) {
    feedVehicleByInsured(mobileNumber: $mobileNumber) {
      vehicles {
        id
        plateNumber
        engineNumber
...
const VehicleByMobileNumber = ({ branchId, path }) => {
  ...
  const [
    vehicleData,
    {
      loading: feedVehicleByInsuredLoading,
      error: feedVehicleByInsuredError,
      data: feedVehicleByInsuredData,
    },
  ] = useLazyQuery(FeedVehicleByInsured);
                    ...
                    <div className="overflow-hidden shadow ring-1 ring-black ring-opacity-5 md:rounded-lg">
                      <table className="min-w-full divide-y divide-gray-300">
                        ...
                        <tbody className="divide-y divide-gray-200 bg-white">
                          {feedVehicleByInsuredData?.feedVehicleByInsured
                            ?.vehicles?.length > 0 &&
                            feedVehicleByInsuredData?.feedVehicleByInsured?.vehicles?.map(
                              (item: any, i: any) => (
                                <tr key={item.id}>
...
export default VehicleByMobileNumber;
